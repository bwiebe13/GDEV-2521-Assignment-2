...
public class Quaternion3D
{
    ...
    public Quaternion3D(float w, float x, float y, float z)
    {
        this.w = w;
        this.x = x;
        this.y = y;
    ...
    public static Quaternion3D FromEuler(float angleDegrees)
    {
        // Create a quaternion from a 3D Euler angle (degrees)
        ...
        return new Quaternion3D(w, x, y, z);
    }

    public float ToEuler()
    {
        // Convert this quaternion to a 3D Euler angle (degrees)
        float radians = 2 * Mathf.Atan2(z,w);
        float degrees = radians * Mathf.Rad2Deg;
        return degrees;
    }

    public static Quaternion3D FromMatrix(Matrix3x3 m)
    {
    ...
    public Quaternion3D Multiply(Quaternion3D q)
    {
        ...
        return new Quaternion3D(wPrime, xPrime, yPrime, zPrime);
    }
}*/